...
local tllexer = require "Sources.tllexer"
...
local G = lpeg.P { "MojoScript";
  MojoScript = tllexer.Shebang^-1 * tllexer.Skip * lpeg.V("Chunk") * -1 +
...
local function traverse (ast, errorinfo, strict)
  ...
  local env = tlst.NewEnv(errorinfo.subject, errorinfo.filename, strict)
