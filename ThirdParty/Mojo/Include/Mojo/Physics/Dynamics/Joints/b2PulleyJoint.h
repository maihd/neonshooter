...
struct b2PulleyJointDef : public b2JointDef
{
	...
	void Initialize(b2Body* bodyA, b2Body* bodyB,
					const float2& groundAnchorA, const float2& groundAnchorB,
...
public:
	...
	float2 GetGroundAnchorA() const;

	/// Get the second ground anchor.
	float2 GetGroundAnchorB() const;
	...
	void ShiftOrigin(const float2& newOrigin) override;
...
protected:
	...
	float2 m_groundAnchorA;
	float2 m_groundAnchorB;
	float m_lengthA;
	float m_lengthB;
