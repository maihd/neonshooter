...
#include "Mojo/Physics/Collision/b2DynamicTree.h"
#include <algorithm>
...
public:
	...
	void MoveProxy(int proxyId, const b2AABB& aabb, const float2& displacement);
...
inline void b2BroadPhase::ShiftOrigin(const float2& newOrigin)
{
