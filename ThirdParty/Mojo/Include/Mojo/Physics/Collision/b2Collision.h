...
struct b2WorldManifold
{
	...
	float2 points[b2_maxManifoldPoints];		///< world contact point (point of intersection)
...
struct b2AABB
{
	...
	float2 lowerBound;	///< the lower vertex
	float2 upperBound;	///< the upper vertex
};
...
{
	float2 d = upperBound - lowerBound;
